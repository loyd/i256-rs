...
fn div_rem_word(hi: ULimb, lo: ULimb, divisor: ULimb) -> (ULimb, ULimb) {
    ...
    // NOTE: PowerPC
    // As of the Power ISA 3.1, Power architectures support 128-bit division
    // natively with the `divdeu` instruction. However, this instruction isn't
    // generated by any compilers to my knowledge and also was introduced in 2020,
    // so it's unlikely to have mainstream support yet.
    // See: https://wiki.raptorcs.com/w/images/f/f5/PowerISA_public.v3.1.pdf#G7.1064095
