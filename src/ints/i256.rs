...
use crate::math::{self, ILimb, ULimb};
use crate::numtypes::*;
use crate::u256;
...
impl i256 {
    ...
    #[inline(always)]
    pub fn div_rem_usmall(self, n: ULimb) -> (Self, ULimb) {
        if cfg!(not(have_overflow_checks)) {
    ...
    #[inline(always)]
    pub fn wrapping_div_rem_usmall(self, n: ULimb) -> (Self, ULimb) {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn checked_div_rem_usmall(self, n: ULimb) -> Option<(Self, ULimb)> {
        if n == 0 {
            None
        } else {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn overflowing_div_rem_usmall(self, n: ULimb) -> ((Self, ULimb), bool) {
        if n == 0 {
            ((Self::MAX, 0), true)
        } else {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn div_rem_ismall(self, n: ILimb) -> (Self, ILimb) {
        if cfg!(not(have_overflow_checks)) {
    ...
    /// wraps, which can never happen in practice.
    #[inline(always)]
    pub fn wrapping_div_rem_ismall(self, n: ILimb) -> (Self, ILimb) {
        const BYTES: usize = (u256::BITS / ULimb::BITS) as usize;
        // SAFETY: Safe since these are plain old data.
        unsafe {
            let x: [ULimb; BYTES] = mem::transmute(self.wrapping_abs().as_u256().to_le_bytes());
            let (div, rem) = math::div_rem_small(&x, n.wrapping_abs() as ULimb);
            let mut div =
                u256::from_le_bytes(mem::transmute::<[ULimb; BYTES], [u8; 32]>(div)).as_i256();
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn checked_div_rem_ismall(self, n: ILimb) -> Option<(Self, ILimb)> {
        if n == 0 {
            None
        } else {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn overflowing_div_rem_ismall(self, n: ILimb) -> ((Self, ILimb), bool) {
        if n == 0 {
            ((Self::MAX, 0), true)
        } else {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn div_usmall(self, n: ULimb) -> Self {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn wrapping_div_usmall(self, n: ULimb) -> Self {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn checked_div_usmall(self, n: ULimb) -> Option<Self> {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn overflowing_div_usmall(self, n: ULimb) -> (Self, bool) {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn div_ismall(self, n: ILimb) -> Self {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn wrapping_div_ismall(self, n: ILimb) -> Self {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn checked_div_ismall(self, n: ILimb) -> Option<Self> {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn overflowing_div_ismall(self, n: ILimb) -> (Self, bool) {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn rem_usmall(self, n: ULimb) -> ULimb {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn wrapping_rem_usmall(self, n: ULimb) -> ULimb {
        self.wrapping_div_rem_usmall(n).1
    }
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn checked_rem_usmall(self, n: ULimb) -> Option<ULimb> {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn overflowing_rem_usmall(self, n: ULimb) -> (ULimb, bool) {
        let (value, overflowed) = self.overflowing_div_rem_usmall(n);
        (value.1, overflowed)
    }
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn rem_ismall(self, n: ILimb) -> ILimb {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn wrapping_rem_ismall(self, n: ILimb) -> ILimb {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn checked_rem_ismall(self, n: ILimb) -> Option<ILimb> {
    ...
    /// This allows optimizations a full division cannot do.
    #[inline(always)]
    pub fn overflowing_rem_ismall(self, n: ILimb) -> (ILimb, bool) {
        let (value, overflowed) = self.overflowing_div_rem_ismall(n);
        (value.1, overflowed)
    }
}
...
impl i256 {
    ...
    pub const fn midpoint(self, rhs: Self) -> Self {
        ...
        let (lo, hi) = math::shr_i128(xor.lo, xor.hi, 1);
